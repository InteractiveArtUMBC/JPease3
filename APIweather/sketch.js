...
function preload() {
  ...
  var url =
   'http://api.openweathermap.org/data/2.5/weather?q=Wales&APPID=78ea8093425037360149387b0242c48e';
...
function draw() {
  ...
  stroke(255);
  fill(0,125,60);
  ellipse(300,400,windspeed*75,windspeed*25);
  fill(110,30,0);
  ...
  fill(0,185,175);
  ellipse(715,495,windspeed*200,windspeed*200);
  fill(40,265,150);
